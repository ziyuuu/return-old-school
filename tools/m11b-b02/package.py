...
body+='<h2>04 / 四层音乐楼 · 明确缺图，不伪造照片</h2><div class="pair"><div class="missing"><h3>没有独立核实的对应原图</h3><p>已查看登记系列及针对性公开检索，仍未得到可以单独确认的旧音乐楼入口/完整立面照片。</p><p><b>A：</b>四层、独立楼体特征、直接贴馆。<br><b>H：</b>窗距、门扇、饰面、雨棚与最小门厅；入口沿用原登记的球场侧偏西位置。</p><p>不拿生成图、2014年后艺术楼或新建方案充当旧楼参考。</p></div>'+screenshot('b02-music.png','实际模型：音乐楼四层墙体、窗洞与平屋顶，直接贴在体育馆后侧组团边界，无连桥或新增连接体。')+'</div>'
