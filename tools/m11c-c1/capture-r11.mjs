...
const viewer=path.join(root,'artifacts/m11c-c1/Yali_C1_R1_1_Viewer.html'),manifest=JSON.parse(fs.readFileSync(path.join(root,'artifacts/m11c-c1/viewer-manifest.json')));
...
const report={stage:'C1',version:'R1.1',status:'IMPLEMENTED / REVIEW_PENDING',phase,group,viewer:path.relative(root,viewer),viewerSHA256:manifest.sha256,sourceCommit:manifest.gitHead,viewport,startedAt:new Date().toISOString(),errors:[],warnings:[],externalRequests:[],screenshots:[],checks:[],passed:false};
