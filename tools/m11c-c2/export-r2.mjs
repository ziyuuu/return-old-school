...
const files=[];
for(const item of [
 {name:'Yali_C2_R2_Viewer.html',entry:'apps/campus/src/main.ts',template:'apps/campus/index.html',tag:'/src/main.ts',label:'复原雅礼 · C2 R2 校服学生漫游'},
 {name:'Yali_C2_R2_Character.html',entry:'apps/campus/src/player/avatar-studio.ts',template:'apps/campus/avatar-r2.html',tag:'/src/player/avatar-studio.ts',label:'复原雅礼 · C2 R2 人物模型工坊'},
]){
 ...
 const manifest={file:item.name,sha256:digest(html),bytes:Buffer.byteLength(html),version:'C2.R2',status:'IMPLEMENTED / REVIEW_PENDING',standard:'1.0 + mobile-r12; additive C2 R2 character surfaces',gitHead:execFileSync('git',['rev-parse','HEAD'],{cwd:root,encoding:'utf8'}).trim(),sources};
