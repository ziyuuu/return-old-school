...
const out=path.resolve('qa/m11c-c2/r2/release',group);fs.mkdirSync(out,{recursive:true});
const name=studio?'Yali_C2_R2_Character.html':'Yali_C2_R2_Viewer.html',viewer=path.resolve('artifacts/m11c-c2/r2',name);
