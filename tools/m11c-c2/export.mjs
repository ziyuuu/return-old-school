...
const root=fileURLToPath(new URL('../../',import.meta.url)),out=path.join(root,'artifacts/m11c-c2');
...
const name='Yali_C2_R1_Viewer.html',digest=b=>createHash('sha256').update(b).digest('hex'),sha256=digest(html);
