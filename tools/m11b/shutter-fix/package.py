...
titles={'r3-west.png':'左端：门洞在侧墙，后墙封回','r3-east.png':'右端：侧墙开启卷帘门','r31-west-door.png':'左端卷帘门近看','r31-east-door.png':'右端卷帘门近看','r3-porch-plan.png':'首层俯看：放大雨棚和端部退让','r3-overview.png':'教学楼整体：主体与门廊关系保留','r3-front.png':'正面：五层、轻弧与中轴保持','mobile.png':'手机尺寸显示检查'}
