...
> 当前修订：**B05 R1.2 / IMPLEMENTED / REVIEW_PENDING**，校友新指示的校园石前置平台、连续侧路围墙与树木建模修正。[本轮说明与复现](docs/m11b/batch05/r12-correction.md)。下文R1.1的Viewer/QA属于保留历史，不代表新修订已完成浏览器验证。
...
**B04 R1：COMPLETE / ALUMNI_APPROVED（2026-09-13）。** 已认可 13 科学馆、17 长雅楼，以及 07／16／21 在证据边界内的保守深化；07医务室线索、16历史用途及21正式身份继续保留U/H，认可不把这些假设升级为实测事实。长雅楼正门直达道路保持不变，不恢复绿色绕路。离线 Viewer：`artifacts/m11b-b04/Yali_B04_R1_Viewer.html`，SHA256 `d8e2b969802cfefcaba9d27da496f26ef8e9d1d85eb2a8bc7681d243f3002eda`。[B04认可](docs/m11b/batch04/acceptance.md) · [机器可读状态](data/m11b/batch04/acceptance.json) · [B04交付](docs/m11b/batch04/delivery.md) · [证据与H边界](docs/m11b/batch04/evidence.md) · [QA](qa/m11b-b04/README.md)。下一批按 [B05启动任务书](docs/m11b/batch05/start-next-thread.md) 接续。
